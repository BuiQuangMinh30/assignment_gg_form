...
const useStyle = makeStyles({
  ...
  listItemGG: {
    fontWeight: "700",
    fontSize: "22px",
    fontFamily: "'Product Sans', sans-serif,Arial",
  },
});
...
function TemporaryDrawer() {
  ...
  const list = (anchor) => (
    <div style={{ width: "250px" }} role="presentation">
      ...
      <List>
        <ListItem>
          <ListItemText style={{ fontSize: "48px", marginLeft: "5px" }}>
            <span
              className={classes.listItemGG}
              style={{ fontWeight: "700", color: "blue" }}
            >
              G
            </span>
            <span className={classes.listItemGG} style={{ color: "red" }}>
              o
            </span>
            <span className={classes.listItemGG} style={{ color: "yellow" }}>
              o
            </span>
            <span className={classes.listItemGG} style={{ color: "blue" }}>
              g
            </span>
            <span className={classes.listItemGG} style={{ color: "green" }}>
              l
            </span>
            <span
              className={classes.listItemGG}
            ...
            <span className={classes.listItemGG} style={{ color: "#5f6368" }}>
              Docs
            </span>
          </ListItemText>
        </ListItem>
      ...
      <List>
      <ListItem className="list_item">
          <FiSettings style={{marginLeft: "10px"}}/>
          <div className={classes.listItem}>Settings</div>
        </ListItem>
        <ListItem className="list_item">
        <BsQuestionCircle style={{marginLeft: "10px"}}/>
      ...
      <ListItem className="list_item">
        <img
            ...
            alt=""
          />
          <div className={classes.listItem}>Drivers</div>
        </ListItem>
